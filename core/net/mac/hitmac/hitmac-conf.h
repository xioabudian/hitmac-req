...
#if HITMAC_CONF_DEFAULT_SCHEDULER_LENGTH == 1800 //15 minutes
...
#define HITMAC_DOWNLOAD_LENGTH (200) //0.5s*200
...
#define HITMAC_SCAN_PERIOD  (CLOCK_SECOND*5)//nodes request associate period  is 60s
...
#define HITMAC_RSSI_THRESHOLD 0xAB /* 0xBA<==>-70  0xB0<==>-80// 0xA6<==>-90 0xA1<==>-95*/
...
#define HITMAC_EB_PERIOD  600//root send eb packet period is 300 second
...
/*define hitmac max channel number*/
#define HITMAC_MAX_CHANNEL_NUMBER HITMAC_MAX_CHANNEL
