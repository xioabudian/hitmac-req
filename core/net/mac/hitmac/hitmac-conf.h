...
#define HITMAC_UPLOAD_LENGTH (3*HITMAC_NODES_NUM) //38.4s (256*3)
...
#define HITMAC_REQ_EB_WAIT_TIMEOFFSET1 (RTIMER_SECOND/61)  //60 59:in a rtimer tick
...
#define HITMAC_ROOT_DOWNLOAD_START_TIME (RTIMER_SECOND/77) //13ms
#define HITMAC_NODE_WAIT_ACK_TIME (RTIMER_SECOND/200) //5ms
#define HITMAC_NODE_WAIT_DATA_TIME (RTIMER_SECOND/25) //40ms
